class Order:
    ...
    Увеличивает счетчик total_orders на 1 каждый раз при создании нового заказа.
    ...
    Пример: Order.calculate_discounted_price(1000, 10) вернет 900.
    Метод total_orders:
    ...
    Метод total_price:
    Вычесляет общую сумму всех товаров в заказе, суммируя их цены.
